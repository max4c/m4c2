...
On the contrary, It is much better to do initial macro ideation and macro planning and then a series of micro loops of what to solve->how to solve->doing the work->verifying the work. If you are coding, a great way to keep track of this is to create a todo.md file where you can have all of the milestones you are hoping to accomplish and relevant links which your coding agent can update. Reach a milestone, do a git commit so you can easily revert back to the latest working milestone, especially crucial as AI can sometimes introduce unexpected issues.
